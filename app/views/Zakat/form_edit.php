...
<!-- Breadcome start-->
      ...
      <form action="<?= BASEURL; ?>/Zakat/edit_data" method="POST">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-9">
                      <div class="form-select-list">
                          <input type="hidden" class="form-control" name="id_zakat" value="<?=$dt['id_zakat'];?>">
                          <input type="text" class="form-control" name="jenis_zakat" value="<?=$dt['jenis_zakat'];?>">
                      </div>
                  </div>
              </div>
          </div>
