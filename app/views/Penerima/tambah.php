<!-- Breadcome start-->
      ...
      <form action="<?= BASEURL; ?>/Penerima/aksi_tambah" method="POST">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-9">
                      <div class="form-select-list">
                          <input type="text" name="nama_penerima" required="required" class="form-control">
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="form-group-inner">
              <div class="row">
                  ...
                  <div class="col-lg-9">
                      <div class="form-select-list">
                          <input id="middle-name" class="form-control" type="text" name="alamat_penerima">
                      </div>
                  </div>
              </div>
          </div>
